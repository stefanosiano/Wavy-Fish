...
public class AdColonyRewardedVideo extends CustomEventRewardedVideo {
     ...
     */
    private static final String DEFAULT_CLIENT_OPTIONS = "version=1.0.10,store:google";
    private static final String DEFAULT_APP_ID = "app4dae859273a54b9e98";
    private static final String[] DEFAULT_ALL_ZONE_IDS = {"vz9f9ba80bbd944b35b0", "vzb9f4269a5adf46eb92"};
    private static final String DEFAULT_ZONE_ID = "vzb9f4269a5adf46eb92";
    ...
    public boolean checkAndInitializeSdk(@NonNull final Activity launcherActivity,
        ...
        synchronized (AdColonyRewardedVideo.class) {
            ...
            String version;
            try{
                PackageInfo pInfo = launcherActivity.getPackageManager().getPackageInfo(launcherActivity.getPackageName(), 0);
            ...
            adColonyClientOptions = "version=" + version + ",store:google";
