	...
	public void setSelectedMode(ButtonNames name){
		...
		switch(name){
			case buttonBlinkingkMode:
				Settings.gameMode = Settings.gameMode.equals(GameMode.normal) ? GameMode.blinking : GameMode.normal;
				break;
			case buttonPiranhaMode:
				Settings.gameObstacle = Settings.gameObstacle.equals(GameObstacle.piranha) ? GameObstacle.wall : GameObstacle.piranha;
				break;
			case buttonEndlessMode:
				Settings.gameEndless = !Settings.gameEndless;
				break;
		}
	}
